...
export const getErrorByStatusCode = (status: string) => {
  switch (status) {
    case ERROR_STATUS_CODES.BAD_REQUEST_LOGIN: return API_ERRORS.WRONG_CREDENTIALS;
    case ERROR_STATUS_CODES.BAD_REQUEST_REGISTRATION: return API_ERRORS.EMAIL_EXIST;
